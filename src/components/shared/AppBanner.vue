<template>
	<section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10 overflow-hidden">
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<div class="flex justify-center sm:block">
				<a download="Stoman-Resume.pdf" href="/files/Alpha-Resume.pdf"
